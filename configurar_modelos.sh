#!/bin/bash
# ===========================================
# 🚀 Script para configurar modelos base en NEUSI DevOps (Django)
# ===========================================
...
echo "=== Creando modelos iniciales en $APP_NAME ==="
...
echo "=== Registrando modelos en admin ==="
...
echo "=== Listo ✅. Modelos y admin configurados ==="
